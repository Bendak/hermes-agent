...
- **Rate limit**: at most 12 session injections per target chat per hour; excess events degrade to `broadcast`; slots free up continuously as the rolling hour passes.
